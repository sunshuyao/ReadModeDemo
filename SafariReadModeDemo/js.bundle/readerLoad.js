...
localizedStrings["Because your system clock is set incorrectly, Safari can’t verify that your connection is private. If you understand the risks involved, you can %visit-this-site-link%."] = "因为您的系统时钟设置不正确，Safari 无法验证其是否为私人连接。如果您已了解涉及的风险，您可以%visit-this-site-link%。";
localizedStrings["Close Page"] = "关闭页面";
localizedStrings["Connect to the Internet to view remaining pages."] = "接入互联网来查看剩余的网页。";
localizedStrings["Deceptive Website Warning"] = "欺骗性网站警告";
localizedStrings["Go Back"] = "返回";
localizedStrings["If you believe this website is safe, you can %report-an-error%. Or, if you understand the risks involved, you can %bypass-link%."] = "如果相信网站安全，您可以%report-an-error%。或者，如果已了解涉及的风险，您可以%bypass-link%。";
localizedStrings["If you understand the risks involved, you can %visit-this-site-link%."] = "如果已了解涉及的风险，您可以%visit-this-site-link%。";
localizedStrings["If you understand the risks involved, you can %visit-this-unsafe-site-link%."] = "如果已了解涉及的风险，您可以%visit-this-unsafe-site-link%。";
localizedStrings["Ignore Warning"] = "忽略警告";
localizedStrings["Learn more…"] = "了解更多…";
localizedStrings["Loading Next Page…"] = "正在载入下一页…";
localizedStrings["Malware Website Warning"] = "恶意软件网站警告";
localizedStrings["Open Date & Time…"] = "打开“日期与时间”…";
localizedStrings["Page %@"] = "第 %@ 页";
localizedStrings["Page %@ of %@"] = "第 %@ 页（共 %@ 页）";
localizedStrings["Phishing websites are designed to trick you into disclosing personal or financial information, usually by creating a copy of a legitimate website, such as a bank’s."] = "仿冒网站常伪装成诸如银行网站之类的合法网站，企图诱骗您的个人资料或财务信息。";
localizedStrings["Possible Phishing Website"] = "可能是钓鱼网站";
localizedStrings["Safari can’t connect to “%hostname%” because your system clock is incorrectly set to %@. Set your system clock to the correct time and try again."] = "Safari 无法连接至“%hostname%”，因为系统时钟被错误设为“%@”。请将系统时钟调正确然后再试。";
localizedStrings["Safari warns you about websites that have been reported as deceptive websites. Deceptive websites try to trick you into believing they are legitimate websites you trust. %phishing-learn-more%"] = "Safari 会针对报告为欺骗性网站的网站向您发出警告。欺骗性网站会尝试诱骗您相信它们是受您信任的合法网站。%phishing-learn-more%";
localizedStrings["Safari warns you about websites where harmful software has been detected. You can check %the-status-of-site% on the %safeBrowsingProvider% diagnostic page."] = "Safari 会针对检测出有害软件的网站向您发出警告。您可以前往%safeBrowsingProvider%诊断页查看%the-status-of-site%。";
localizedStrings["Safari warns you about websites where malicious software has been detected. You can check the %status-link% on the %safeBrowsingProvider% diagnostic page."] = "Safari 会针对检测出恶意软件的网站向您发出警告。您可以前往 %safeBrowsingProvider% 诊断页查看 %status-link%。";
localizedStrings["Safari warns you when a website has %certificate-description%. %expiration-date-details%. This may happen if the website is misconfigured, an attacker has compromised your connection, or your system clock is incorrect. Your system clock is set to %@. If this is not right, %fixing-the-clock% may address this warning."] = "Safari 会在网站%certificate-description%时警告您。%expiration-date-details%。它可能在网站配置错误、外来攻击影响连接或系统时钟设置不正确时出现。您的时钟设为%@。如果不正确，%fixing-the-clock%可能会处理此警告。";
localizedStrings["Safari warns you when a website has a certificate that is not valid. This may happen if an attacker has compromised your connection. For your protection, you can’t visit this website. You can check back later to see if this issue has been resolved. You can also contact the website owner to tell them about this error."] = "Safari 会在网站证书无效时警告您。它可能在外来攻击影响连接时出现。为了保护您，您无法访问此网站。您可以稍后查看此问题是否已被解决。您还可以联系网站所有人并告知其此错误。";
localizedStrings["Safari warns you when a website has a certificate that is not valid. This may happen if the website is misconfigured or an attacker has compromised your connection."] = "Safari 会在网站证书无效时警告您。它可能在网站配置错误或外来攻击影响连接时出现。";
localizedStrings["Show Details"] = "显示详细信息";
localizedStrings["The address for the website you’re visiting contains a username or password. This may be a “phishing” website."] = "您正访问的网站地址包含用户名或密码。这可能是“仿冒”网站。";
localizedStrings["This Connection Is Not Private"] = "此连接非私人连接";
localizedStrings["This website may attempt to install dangerous software, which could harm your computer or steal your personal or financial information, like passwords, photos, or credit cards."] = "此网站可能尝试安装危险软件，可能危害您的电脑或窃取您的个人或财务信息，如密码、照片或信用卡。";
localizedStrings["This website may be impersonating “%hostname%” to steal your personal or financial information. You should close this page."] = "此网站可能在冒充“%hostname%”来窃取您的个人或财务信息。您应关闭此页面。";
localizedStrings["This website may be impersonating “%hostname%” to steal your personal or financial information. You should go back to the previous page."] = "此网站可能在冒充“%hostname%”来窃取您的个人或财务信息。您应回到之前的页面。";
localizedStrings["This website may try to trick you into doing something dangerous, like installing software or disclosing personal or financial information, like passwords, phone numbers, or credit cards."] = "此网站可能尝试诱骗您进行危险操作，如安装软件或泄露个人或财务信息，如密码、电话号码或信用卡。";
localizedStrings["This website may try to trick you into installing software that harms your browsing experience, like changing your settings without your permission or showing you unwanted ads. Once installed, it may be difficult to remove."] = "此网站可能尝试诱骗您安装危害您浏览体验的软件，如未经您许可更改设置或显示您不希望看到的广告。一旦安装，移除可能会很困难。";
localizedStrings["To learn more, you can %view-the-certificate%."] = "若要了解更多信息，您可以%view-the-certificate%。";
localizedStrings["Website With Harmful Software Warning"] = "含有害软件警告的网站";
localizedStrings["Your Clock Is Set Incorrectly"] = "您的时钟设置不正确";
localizedStrings["a certificate that is not valid"] = "证书无效";
localizedStrings["an expired certificate"] = "证书过期";
localizedStrings["fixing the clock"] = "修复时钟";
localizedStrings["malware status of “%site%”"] = "“%site%”恶意软件状态";
localizedStrings["report an error"] = "报告错误";
localizedStrings["the status of “%site%”"] = "“%site%”状态";
localizedStrings["view the certificate"] = "查看此证书";
localizedStrings["visit this unsafe website"] = "访问此不安全网站";
localizedStrings["visit this website"] = "访问此网站";
...
function articleScrolled() {
    ...
    // ss // !scrollEventIsSmoothScroll && smoothScrollingAnimator && abortSmoothScroll(), ReaderJSController.articleScrolled()
}
...
ReaderController = function () {
    ...
    loaded: function () {
        ...
        window.webkit.messageHandlers.Viaduct.postMessage(message);
    },
...
function ssMemorizeStartScrollPosition() {
    ssStartScrollPosition = window.scrollY;
}

function ssRemoveReaderModeTips() {
    if (Math.abs(window.scrollY - ssStartScrollPosition) >= 2 * window.innerHeight) {
        var msg = {
            func: "jsDidScroll",
            options: {
        ...
        window.webkit.messageHandlers.Viaduct.postMessage(msg);
        console.log("reader mode tips removed");
        window.removeEventListener("scroll", ssRemoveReaderModeTips);
    }
}

setTimeout(function () {
    ContentAwareScrollerJS = new ContentAwareScroller,
    ...
    ssStartScrollPosition = 0;

    if (ReaderArticleFinderJS.isReaderModeAvailable()) {
        window.addEventListener("scroll", ssRemoveReaderModeTips);
    }

    var message = {
        func: 'readerModeReadyForCheck',
        options: {}
    };
    window.webkit.messageHandlers.Viaduct.postMessage(message);
}, 600);
